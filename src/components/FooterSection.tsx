...
export default function FooterSection() {
  ...
  return (
    <footer id="contact" ref={sectionRef} className="bg-stone-950 min-h-screen flex flex-col py-12 md:py-16 border-t border-stitching relative overflow-hidden">
      ...
      <div className="w-full max-w-[1920px] ultrawide:max-w-[2560px] mx-auto px-6 md:px-12 ultrawide:px-32 relative z-10 flex-1 flex flex-col">
        ...
        <div ref={footerBottomRef} className="pt-8 border-t border-white/5 grid grid-cols-1 md:grid-cols-3 gap-6 items-center w-full">
          ...
          {/* Center: Social Links */}
          <div className="flex justify-center gap-8 text-[11px] md:text-xs ultrawide:text-sm uppercase tracking-[0.3em] text-stone-400">
