...
export default function FeaturesSection() {
  ...
  return (
    <section ref={sectionRef} className="relative min-h-screen flex flex-col justify-center py-12 md:py-16 text-stone-200 overflow-hidden bg-stone-950">
      ...
      <div className="relative z-10 w-full max-w-[1920px] ultrawide:max-w-[2560px] mx-auto px-6 md:px-12 ultrawide:px-32 flex-1 flex flex-col justify-center">
        ...
        <div className="mb-8 md:mb-12 flex flex-col md:flex-row md:items-end md:justify-between gap-6 feature-header-container">
          <div className="flex flex-col">
            <span className="text-leather-light text-xs ultrawide:text-sm uppercase tracking-[0.4em] mb-4 block feature-header-sub">
              El Compromiso
            </span>
          ...
          <p className="text-stone-400 text-base ultrawide:text-xl font-light leading-relaxed max-w-xs ultrawide:max-w-md md:text-right md:pb-1 feature-header-sub">
              ...
              <div className="relative overflow-hidden rounded-sm border border-white/10 bg-stone-900/80">
                ...
                <div className="p-6 md:p-8 flex flex-col gap-4">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <span className="text-[11px] ultrawide:text-xs uppercase tracking-[0.25em] text-stone-500 feature-text">
                      {feature.accent}
                    </span>
                  </div>
                  ...
                  {/* Description */}
                  <p className="text-stone-400 text-base ultrawide:text-lg font-light leading-relaxed feature-text">
                    {feature.desc}
                  </p>
                </div>
              </div>
