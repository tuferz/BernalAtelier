    ...
    <section id="gallery" ref={sectionRef} className="relative h-[100svh] bg-stone-950 overflow-hidden">
      ...
      <div className="relative z-10 w-full h-full flex flex-col justify-center py-12 md:py-20 overflow-hidden">
        ...
        <div className="portfolio-header flex flex-col items-center text-center space-y-4 md:space-y-6 mb-8 md:mb-12 flex-shrink-0">
          <span className="text-leather-light text-[10px] md:text-xs ultrawide:text-sm uppercase tracking-[0.4em]">La Colección</span>
          <div className="pb-4">
            <h2 className="text-3xl md:text-5xl lg:text-6xl ultrawide:text-8xl font-serif leading-[1.1] max-w-2xl ultrawide:max-w-4xl text-stone-200">
        ...
        <div className="flex-1 flex items-center min-h-0 w-full">
          ...
          {PRODUCTS.map((p, i) => (
            ...
            >
              ...
              <div className="relative overflow-hidden aspect-[4/3] md:aspect-[3/4] h-[35vh] md:h-[45vh] lg:h-[50vh] ultrawide:h-[60vh] bg-stone-900 group cursor-pointer border border-white/10">
                <Image
                  src={p.img}
                  alt={p.title}
                  fill
